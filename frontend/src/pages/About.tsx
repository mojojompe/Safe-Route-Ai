        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 p-6 bg-white/5 rounded-4xl backdrop-blur-sm border border-white/10">
            ...
            <section>
              ...
              <div className="p-6 bg-white/5 rounded-4xl text-center backdrop-blur-sm border border-white/10">
                <p className="text-gray-300">
