        ...
        <main className="flex-1 p-6 lg:p-10">
          <div className="mx-auto max-w-4xl">
            <div className="flex flex-col gap-2 mb-8 text-center">
              <h1 className="text-white text-4xl font-black leading-tight tracking-[-0.033em]">Your Profile</h1>
              <p className="text-gray-400 text-lg font-normal leading-normal">Manage your account settings and preferences.</p>
            </div>

            <div className="bg-white/5 rounded-xl p-8 flex flex-col items-center gap-6">
              ...
              <div className="w-full max-w-md flex flex-col gap-4">
                <button className="w-full py-3 px-4 rounded-lg bg-primary text-sr-dark font-bold hover:bg-primary/90 transition-colors">
                  Edit Profile
                </button>
                <button className="w-full py-3 px-4 rounded-lg border border-white/10 text-white font-medium hover:bg-white/5 transition-colors">
                  Change Password
                </button>
