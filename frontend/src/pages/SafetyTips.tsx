        ...
        <main className="flex-1 p-6 lg:p-10">
          <div className="mx-auto max-w-5xl">
              ...
              <div className="w-full sm:w-auto sm:max-w-xs">
                <label className="flex flex-col min-w-40 h-12 w-full">
                  <div className="flex w-full flex-1 items-stretch rounded-xl h-full bg-black/5 dark:bg-white/5">
                    ...
                    <input className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-r-xl text-gray-900 dark:text-white focus:outline-0 focus:ring-0 border-none bg-transparent h-full placeholder:text-gray-500 dark:placeholder:text-gray-400 pl-2 text-base font-normal leading-normal" placeholder="Search for a specific tip" />
                  </div>
                </label>
              </div>
              {/* Tabs */}
              <div className="w-full sm:w-auto">
                <div className="flex border-b border-black/10 dark:border-white/10 w-full">
                  <button
                    ...
                    className={`flex flex-1 items-center justify-center gap-2 border-b-[3px] pb-2.5 pt-2.5 sm:flex-initial sm:px-6 transition-colors ${activeTab === 'Walking' ? 'border-b-primary text-primary' : 'border-b-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}`}
                  >
                  ...
                  <button
                    ...
                    className={`flex flex-1 items-center justify-center gap-2 border-b-[3px] pb-2.5 pt-2.5 sm:flex-initial sm:px-6 transition-colors ${activeTab === 'Driving' ? 'border-b-primary text-primary' : 'border-b-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}`}
                  >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              <div className="flex flex-col gap-3 rounded-xl bg-black/5 dark:bg-white/5 p-4 transition-all hover:bg-black/10 dark:hover:bg-white/10">
